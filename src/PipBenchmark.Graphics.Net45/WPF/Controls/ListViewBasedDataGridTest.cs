...
{
    public class ListViewBasedDataGridTest : PassiveBenchmark
    {
        private const string Name1Text = "ListViewBasedDataGridRandomData";
        private const string Name2Text = "ListViewBasedDataGridGrowList";
        ...
        private DataGridWindow _window;

        ObservableCollection<DataItem> _dataItems = new ObservableCollection<DataItem>();

        public ListViewBasedDataGridTest(bool growOnly)
            : base(
