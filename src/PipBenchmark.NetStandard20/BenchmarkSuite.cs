...
namespace PipBenchmark
{
    public abstract class BenchmarkSuite
    {
        ...
        protected Parameter CreateParameter(string name, string description, string defaultValue = null)
        {
        ...
        protected Benchmark CreateBenchmark(string name, string description, Action executeAction)
        {
